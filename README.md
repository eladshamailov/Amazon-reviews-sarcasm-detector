...
Implementation of a real-world application that distributively processes a list of amazon reviews,
...
Now, we have to run this line in the terminal with the names of our input files and the n we chose.
```
