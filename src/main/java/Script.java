...
public class Script {
    ...
    Script(){
        ...
        managerScript = new String(Base64.encodeBase64(managerBuild.toString().getBytes()));
        ...
        workersScript = new String(Base64.encodeBase64(workersBuild.toString().getBytes()));
    }
